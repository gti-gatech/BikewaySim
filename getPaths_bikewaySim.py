...
os.environ['PROJ_LIB'] = '/Users/diyi93/Desktop/gra/TransitSim'  # need to change this when necessary
...
def samp_pre_process(filename, dict_settings):
...
def Bike_route_finder(row, option, dict_settings):
    ...
    if plot_all:
        for i, path in enumerate(paths):
            trip_plot = plot_seq(path, gpd_df=dict_settings['network']['bike']['links'])
...
def plot_seq(trip_seq, gpd_df, skeleton=None):
    """
...
if __name__ == '__main__':
    ...
    # os.environ['PROJ_LIB'] = '/Users/diyi93/Desktop/gra/TransitSim'
    ...
    # TODO: Implement STRATEGY CODE for backward search
